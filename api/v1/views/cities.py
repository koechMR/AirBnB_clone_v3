...
# Updates attributes of the City object with the JSON data
        for key, value in data.items():
	if key not in ignore_keys:
                setattr(city, key, value)

# Saves updated City object to the storage
        city.save()
# Returns updated City object in JSON format with 200 status code
        return jsonify(city.to_dict()), 200
    else:
        # Returns 404 error if City object is not found
        abort(404)
